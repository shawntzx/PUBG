...
kd.5b <- kd%>%filter(ratio<0.5)  
kd.5u <- kd%>%filter(ratio>0.5 & ratio<100)
ggplot(kd.5b,aes(x=ratio,y=team_placement))+geom_point()+
  xlab('Kill ratio')+ylab('Team placement') + ggtitle("Scatter plot of team placement vs kill ratio")
ggplot(kd.5u,aes(x=ratio,y=team_placement))+geom_point()+
  xlab('Kill ratio')+ylab('Team placement') + ggtitle("Scatter plot of team placement vs kill ratio")
```